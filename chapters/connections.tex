...
With a connection $H ⊆ \TT ℱ$ defined on a bundle, a value in the bulk may be moved between fibres so that the motion is always horizontal with respect to the connection.
