...
Less trivially, a rotation in $\RR^3$ by $θ$ may be represented by its \textdef{Rodrigues vector}\sidenotemark\ $\vb r = \vb{\hat{r}}\tan\fracθ2$ pointing along the axis of rotation.
...
% \toself{Be explicit about the (1,3) to (3) split.}
