...
Using the STA, the `kind' of a Lorentz transformation (equivalently, of its associated rotors) is given by simple properties of its generating bivector.\sidenote{
