...
While the overall physics is agnostic, expressions written in the STA are generally not independent of the choice of sign.
It is a helpful reference to note what changes and what is common to both choices.
...
The choice of metric sign may be rendered irrelevant by using sign-agnostic expressions.
...
This similarity can be made more precise: just as we may express complex numbers in polar form $re^{iϕ} = x + iy$, we may use the invariant bivector decomposition to write $ρe^{\vol σ} = E + \vol B$.
