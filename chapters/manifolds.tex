...
\subsection{Structure--preserving connections}
...
\begin{math}
	\df Γ(λX) = λ \df Γ(X)
.\end{math}
This means we may regard $Γ_𝒖$ as a matrix which acts on vectors by matrix multiplication, and $\df Γ$ as a matrix-valued $1$-form,
\begin{align}
	\df Γ X ≔ \df Γ(X)
.\end{align}
