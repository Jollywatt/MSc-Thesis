...
Recall that the connection map is a bulk-valued $1$-form $Γ|_p : \TT_{π(p)} → H_p$.
...
For a linear connection, the components $Γ_μ{}^a|_p$ are linear with respect to the point $p ∈ 𝒱$, allowing the definition of a $3$-index component object
\begin{align}
